...
### Faza 6.5 — `/amendamente` derived ✅ — **154 proiecte / 1.820 amendamente**

- [x] Discovery: amendamentele NU sunt structurate pe cdep.ro (sunt în PDF-uri raport comisie). Decizie: extrag metadatele care există în pagina detaliu proiect (numere, termen, link PDF).
- [x] Schema Proiect extinsă cu 4 câmpuri: `amendamente_termen_depunere`, `amendamente_admise`, `amendamente_respinse`, `raport_comisie_pdf`.
- [x] Re-parsare 1.641 proiecte cu noile câmpuri — 154 cu amendamente trackate (1.669 admise + 151 respinse).
- [x] Builder `scripts/build_amendamente.py` — view derivat sortat descrescător după total amendamente.
- [x] Endpoint `/amendamente/legislatura-{leg}.json` cu slim view pentru jurnaliști.
- [x] Top 3 cele mai disputate: PL-x 5/2024 (133 amend.), PL-x 192/2024 (105 amend.), PL-x 569/2024 (85 amend.).
