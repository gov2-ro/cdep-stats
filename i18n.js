...
const I18N = {
  ro: {
    ...
    card_avere_desc: "Topuri averi: conturi, venituri, datorii — agregat și pe partide.",
    card_averepp_desc: "Averea fiecărui deputat, vizualizată cerc cu cerc.",
  ...
  en: {
    ...
    card_avere_desc: "Wealth leaderboards: accounts, income, debts — aggregate and by party.",
    card_averepp_desc: "Each deputy's wealth, visualized circle by circle.",
