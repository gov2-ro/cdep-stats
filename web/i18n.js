...
const I18N = {
  ro: {
    ...
    home_disputed: "Cele mai disputate proiecte (după amendamente)",
    home_deputies: "Caută un deputat",
    home_search_ph: "Caută deputat…",
    card_avere_desc: "Topuri averi: conturi, venituri, datorii — agregat, pe partide și pe deputat.",
    card_activitate_desc: "Ședințe, luări de cuvânt, propuneri și legi promulgate.",
    card_interpelari_desc: "Cine întreabă, pe cine și despre ce.",
    card_proiecte_desc: "Fluxul legislativ: înregistrate → adoptate → promulgate.",
    card_partide_desc: "Comparație între grupurile parlamentare.",
    card_judete_desc: "Deputați și averi, defalcate pe județ.",
  ...
  en: {
    ...
    home_disputed: "Most-disputed bills (by amendments)",
    home_deputies: "Find a deputy",
    home_search_ph: "Search deputy…",
    card_avere_desc: "Wealth leaderboards: accounts, income, debts — aggregate, by party and per deputy.",
    card_activitate_desc: "Sessions, floor speeches, proposals and promulgated laws.",
    card_interpelari_desc: "Who asks, whom, and about what.",
    card_proiecte_desc: "The legislative funnel: registered → adopted → promulgated.",
    card_partide_desc: "Comparison across parliamentary groups.",
    card_judete_desc: "Deputies and wealth, broken down by county.",
...
function injectGithubLink() {
  ...
  a.href = "https://github.com/gov2-ro/cdep-stats";
  a.target = "_blank";
  a.rel = "noopener";
  a.setAttribute("aria-label", "GitHub");
  a.style.cssText = "color:var(--text3);line-height:1;display:inline-flex;align-items:center;flex-shrink:0";
  a.innerHTML = '<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0112 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z"/></svg>';
